#Citation: Obtained from the makefile used in Group Project. Written by Lauren Boone, Lauren Briese, Robert Jones
# Andrew Wilson and myself.
#Project name, used for naming zip
PROJECT = FinalProject_Shvarts_Daniel
